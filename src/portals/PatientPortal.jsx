...
export default function PatientPortal({
    ...
    const [medicalHistory, setMedicalHistory] = useState({  // ← ADD HERE
        bloodType: "",
        allergies: "",
        currentMedications: "",
        pastConditions: "",
    ...
    const handleBookAppointment = async (e) => {
        ...
        try {
            ...
            setBookingTime("");
            setComplaint("");
            setMedicalHistory({ bloodType: "", allergies: "", currentMedications: "", pastConditions: "", previousSurgeries: "" }); // ← ADD HERE
                                ...
                                <div className="adm-form-card">
                                    ...
                                    {selectedDoctor ? (
                                        <form onSubmit={handleBookAppointment} className="adm-form">
                                            ...
                                            <div className="adm-field">
                                                <label className="adm-label">Allergies</label>
                                                <input className="adm-input" value={medicalHistory.allergies} onChange={(e) => setMedicalHistory({ ...medicalHistory, allergies: e.target.value })} placeholder="e.g. Penicillin, Peanuts" />
                                            </div>
                                            <div className="adm-field">
                                                <label className="adm-label">Current Medications</label>
                                                <textarea className="adm-input adm-textarea" rows={2} value={medicalHistory.currentMedications} onChange={(e) => setMedicalHistory({ ...medicalHistory, currentMedications: e.target.value })} placeholder="e.g. Metformin 500mg daily" />
                                            </div>
                                            <div className="adm-field">
                                                <label className="adm-label">Past Conditions</label>
                                                <textarea className="adm-input adm-textarea" rows={2} value={medicalHistory.pastConditions} onChange={(e) => setMedicalHistory({ ...medicalHistory, pastConditions: e.target.value })} placeholder="e.g. Hypertension, Diabetes" />
                                            </div>
                                            <div className="adm-field">
                                                <label className="adm-label">Previous Surgeries</label>
                                                <textarea className="adm-input adm-textarea" rows={2} value={medicalHistory.previousSurgeries} onChange={(e) => setMedicalHistory({ ...medicalHistory, previousSurgeries: e.target.value })} placeholder="e.g. Appendectomy 2019" />
                                            </div>
